...
function BreadcrumbCollapsed(props) {
  ...
  return (0, import_jsx_runtime6.jsx)("li", {
    children: (0, import_jsx_runtime6.jsx)(BreadcrumbCollapsedButton, _extends({
      focusRipple: true
    }, otherProps, {
      ownerState,
      children: (0, import_jsx_runtime6.jsx)(BreadcrumbCollapsedIcon, _extends({
...
var _excluded4 = ["children", "className", "component", "slots", "slotProps", "expandText", "itemsAfterCollapse", "itemsBeforeCollapse", "maxItems", "separator"];
...
var Breadcrumbs = React12.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  const allItems = React12.Children.toArray(children2).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime7.jsx)(BreadcrumbsRoot, _extends({
    ref,
    component,
...
//# sourceMappingURL=chunk-YGTZIPYR.js.map
