...
INSERT INTO pet_photos (id, pet_id, url, is_primary, sort_order) VALUES
  ('b0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000001','https://placehold.co/400x300/f5a623/ffffff?text=Buddy',true,0),
  ('b0000001-0000-0000-0000-000000000002','a0000001-0000-0000-0000-000000000002','https://placehold.co/400x300/8b5e3c/ffffff?text=Max',true,0),
  ('b0000001-0000-0000-0000-000000000003','a0000001-0000-0000-0000-000000000003','https://placehold.co/400x300/c8a26b/ffffff?text=Charlie',true,0),
  ('b0000001-0000-0000-0000-000000000004','a0000001-0000-0000-0000-000000000004','https://placehold.co/400x300/aaaaaa/ffffff?text=Rocky',true,0),
  ('b0000001-0000-0000-0000-000000000005','a0000001-0000-0000-0000-000000000005','https://placehold.co/400x300/f5d08a/ffffff?text=Bella',true,0),
  ('b0000002-0000-0000-0000-000000000001','a0000002-0000-0000-0000-000000000001','https://placehold.co/400x300/87ceeb/ffffff?text=Luna',true,0),
  ('b0000002-0000-0000-0000-000000000002','a0000002-0000-0000-0000-000000000002','https://placehold.co/400x300/d4a0d4/ffffff?text=Mochi',true,0),
  ('b0000002-0000-0000-0000-000000000003','a0000002-0000-0000-0000-000000000003','https://placehold.co/400x300/8fbc8f/ffffff?text=Nala',true,0),
  ('b0000002-0000-0000-0000-000000000004','a0000002-0000-0000-0000-000000000004','https://placehold.co/400x300/708090/ffffff?text=Oliver',true,0),
  ('b0000002-0000-0000-0000-000000000005','a0000002-0000-0000-0000-000000000005','https://placehold.co/400x300/e8d5b7/333333?text=Cleo',true,0),
  ('b0000003-0000-0000-0000-000000000001','a0000003-0000-0000-0000-000000000001','https://placehold.co/400x300/98fb98/333333?text=Kiwi',true,0),
  ('b0000003-0000-0000-0000-000000000002','a0000003-0000-0000-0000-000000000002','https://placehold.co/400x300/808080/ffffff?text=Rio',true,0),
  ('b0000003-0000-0000-0000-000000000003','a0000003-0000-0000-0000-000000000003','https://placehold.co/400x300/ffd700/333333?text=Sunny',true,0),
  ('b0000003-0000-0000-0000-000000000004','a0000003-0000-0000-0000-000000000004','https://placehold.co/400x300/ff6347/ffffff?text=Pepper',true,0),
  ('b0000003-0000-0000-0000-000000000005','a0000003-0000-0000-0000-000000000005','https://placehold.co/400x300/4169e1/ffffff?text=Echo',true,0),
  ('b0000004-0000-0000-0000-000000000001','a0000004-0000-0000-0000-000000000001','https://placehold.co/400x300/ff8c00/ffffff?text=Nemo',true,0),
  ('b0000004-0000-0000-0000-000000000002','a0000004-0000-0000-0000-000000000002','https://placehold.co/400x300/dc143c/ffffff?text=Ariel',true,0),
  ('b0000004-0000-0000-0000-000000000003','a0000004-0000-0000-0000-000000000003','https://placehold.co/400x300/ffd700/333333?text=Bubbles',true,0),
  ('b0000004-0000-0000-0000-000000000004','a0000004-0000-0000-0000-000000000004','https://placehold.co/400x300/00bfff/ffffff?text=Dory',true,0),
  ('b0000004-0000-0000-0000-000000000005','a0000004-0000-0000-0000-000000000005','https://placehold.co/400x300/ff4500/ffffff?text=Flash',true,0);
